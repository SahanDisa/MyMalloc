...
char memory[n];
	//size of a char is 1 byte, so size of a char array of 25000 elements is 25000 bytes
void *ptr;
static int a = 0;//work as a position var through the main memory
//OS variables
int sp_os_mem;//allocate memory for this variables for last 8 bytes in the memory for simplicity
int sp_os_mem1;
